...
// マクロ定義
//=============================================================================
#define	TEXTURE_TITLE		"data/TEXTURE/gametitle.png"			// 読み込むテクスチャファイル名
//#define	TEXTURE_TITLE_LOGO	"data/TEXTURE/ウイルスショット.png"	// 読み込むテクスチャファイル名
#define	TEXTURE_LOGO_START	"data/TEXTURE/pressエンタ.png"		// 読み込むテクスチャファイル名

//#define	TITLE_LOGO_POS_X		(250)		// タイトルロゴの位置(X座標)320
//#define	TITLE_LOGO_POS_Y		(200)		// タイトルロゴの位置(Y座標)40
//#define	TITLE_LOGO_WIDTH		(800)		// タイトルロゴの幅640
