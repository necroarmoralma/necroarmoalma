...
// マクロ定義
//*****************************************************************************
#define	TEXTURE_RESULT		"data/TEXTURE/Gameover.png"		// 読み込むテクスチャファイル名
#define	TEXTURE_RESULT_LOGO	"data/TEXTURE/Gameover.png"	// 読み込むテクスチャファイル名
#define	TEXTURE_WIN		"data/TEXTURE/win.png"		// 読み込むテクスチャファイル名
...
void UpdateResult(void)
{
	...
	if(GetKeyboardTrigger(DIK_RETURN) || keystroke.Flags & XINPUT_KEYSTROKE_KEYDOWN && keystroke.VirtualKey == VK_PAD_START)
